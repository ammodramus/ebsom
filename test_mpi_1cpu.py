...
rank = comm.Get_rank()
if rank > 1:
    print 'extra MPI process with rank {}, exiting'.format(rank)
    sys.exit(0)
...
if (not args.init_params) and (args.num_no_polymorphism_training_batches > 0):
    ...
    while init_batches_completed < args.num_no_polymorphism_training_batches:
        ...
        while batch_idx < num_batches:
            ...
            if init_batches_completed >= args.num_no_polymorphism_training_batches:
                done = True
                break
